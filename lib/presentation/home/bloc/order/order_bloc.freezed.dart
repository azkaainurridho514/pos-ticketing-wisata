...
class _$SuccessImpl implements _Success {
  ...
  @override
  String toString() {
    return 'OrderState.success(orders: $orders, totalQty: $totalQty, totalPrice: $totalPrice, paymentNominal: $paymentNominal, paymentMethod: $paymentMethod, cashierId: $cashierId, cashierName: $cashierName)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(orders, totalQty, totalPrice, paymentNominal, paymentMethod,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(orders, totalQty, totalPrice, paymentNominal,
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    if (success != null) {
      return success(orders, totalQty, totalPrice, paymentNominal,
          paymentMethod, cashierId, cashierName);
    }
    return orElse();
  }
